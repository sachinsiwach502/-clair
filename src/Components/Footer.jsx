function Footer() {
    return (
        <section className=" pt_lg_152 pt_sm_80 pt-5 pb_40 overflow-hidden">
            <div className=" container">
                <div className="d-flex flex-column align-items-center justify-content-center">
                    <div className="max-w-626">
                        <h1 className=" fw-semibold fs-61 lh-72  ff-sans text-center mb-0">
                            <a href="#" className="primary-color">$CLAIR</a>
                        </h1>
                        <p className=" mb-0 black-200 ff-sans text-center fw-normal fs-16 pt-3">In this meme-driven world, laughter is not just a reaction; it's a powerful tool for chang
