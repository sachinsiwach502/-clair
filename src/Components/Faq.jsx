...
function Faq() {
    return (
        <section className="faq_bg_img pt_80 pb_160">
            <div className="container_800 pt_90 pb_97">
                <h1 className=' text-center text-white fw-semibold fs-48 lh-56 lh-md-37 fs-md-32'>Frequently Asked <span className=' primary-color'>Questions </span> </h1>

                <Accordion defaultActiveKey="0">
                    <Accordion.Item eventKey="0" className=' mt_60'>
