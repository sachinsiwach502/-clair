...
import hero_sec_img from '../assets/img/png/hero_sec_img.png';
import dropdown_img from '../assets/img/png/dropdown_img.png';
import btn_img from '../assets/img/svg/button_img.svg';
import downside_icon from '../assets/img/png/downside_icon.png'
        ...
        <>
            <header className='header_bg_img min-vh-100 d-flex flex-column position-relative'>
                    ...
                    <div className='container_1140'>
                        <div className=' d-flex align-items-center justify-content-between'>
                            ...
                            <div className=' d-flex align-items-center gap_60'>
                                <ul className=' d-flex align-items-center gap_32 mb-0'>
                                    <li>
                ...
                <div className=' d-flex flex-column justify-content-center align-items-center flex-grow-1'>
                    <h1 className=' text-center text-white ff-sans fs-61 lh-72 fw-bold mb-0'>
                    ...
                    <img src={hero_sec_img} alt="hero sec" />
                </div>
            </header>
        </>
    )
